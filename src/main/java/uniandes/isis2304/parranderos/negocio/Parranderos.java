...
public class Parranderos 
{
	...
	public Habitacion adicionarHabitacion(long id, long idHotel, int tipo, String reservada, String ocupada, int capacidad, double costo) {
		log.info("Añadiendo habitación al hotel");
		Habitacion h = pp.adicionarHabitacion(id, idHotel, tipo, reservada, ocupada, capacidad, costo);
		log.info("Adicionando habitación: " + id);
		return h;
	}
	
	public Cliente adicionarCliente (long pId, String tipoDoc, String nombre, String correo){
		log.info("AÃ±adiendo cliente");
		Cliente cliente = pp.adicionarCliente(pId, tipoDoc, nombre, correo);
		log.info("Adicionando el cliente: " + nombre);
		return cliente;
	}
	
	public TipoUsuario adicionarTipoUsuario(int pId, String pDesc){
		log.info("AÃ±adiendo tipo de usuario");
		TipoUsuario tipo = pp.adicionarTipoUsuario(pId, pDesc);
		log.info("Adicionando tipoUsuario: " + pDesc);
		return tipo;
	}
	...
	public Usuario adicionarUsuario(long pId, String tipoDocumento, String nombre, String correo, int pTipo, int idHotel) {
		...
		Usuario u = pp.adicionarUsuario(pId, tipoDocumento, nombre, correo, pTipo, idHotel);
